    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(blank=True, null=True, related_name='dish_halves', to='health_app.category', verbose_name='Категория')),
                ('contraindications', models.ManyToManyField(blank=True, to='health_app.allergy', verbose_name='Противопоказания')),
                ('ingredients', models.ManyToManyField(blank=True, to='health_app.ingredient', verbose_name='Продукты')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rating', to='health_app.product', verbose_name='Половинка')),
